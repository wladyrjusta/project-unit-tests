...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Teste se circle retorna um objeto', () => {
    const object = circle(5);
    expect(typeof object).toBe('object');
  });
  it('Teste se o objeto retornado possui 3 propriedades', () => {
    const object = circle(5);
    const proprieties = Object.keys(object);
    expect(proprieties.length).toBe(3);
  });
  ...
  it('Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.', () => {
    ...
    // OK Teste se circle retorna undefined, caso o parâmetro passado não seja um número.
    // OK Teste se circle retorna um objeto.
    // OK Teste se o objeto retornado possui 3 propriedades.
    // OK Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
    ...
    // OK Teste se a função retorna, em um objeto, os dados corretos de um círculo de raio 3.
});

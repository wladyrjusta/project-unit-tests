...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Teste se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
    expect(getCharacter('Rhaenyra')).toBeUndefined();
  });
    // ESCREVA SEUS TESTES ABAIXO:
    // 1. OK Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
    // 2. OK Teste se a função retorna o objeto correto para o parâmetro 'Arya',
    // 3. OK Teste se a função retorna o objeto correto para o parâmetro 'Brienne',
    // 4. OK Teste se a função retorna o objeto correto para o parâmetro 'Melissandre',
    // 5. OK Teste se o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.
    // 6. OK Teste se ao passar um nome que não está na tabela, a função retorna undefined.
});
